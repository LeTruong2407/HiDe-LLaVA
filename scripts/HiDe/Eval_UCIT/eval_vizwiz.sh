...
RESULT_DIR="${RESULT_DIR:-./results/UCIT/each_dataset/VizWiz}"
QUESTION_FILE="${QUESTION_FILE:-$INSTRUCTION_ROOT/VizWiz/test_3000.json}"
ANNOTATION_FILE="${ANNOTATION_FILE:-$INSTRUCTION_ROOT/VizWiz/val_coco_type_3000.json}"
