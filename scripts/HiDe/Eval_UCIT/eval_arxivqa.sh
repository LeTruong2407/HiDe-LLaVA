...
RESULT_DIR="${RESULT_DIR:-./results/UCIT/each_dataset/ArxivQA}"
QUESTION_FILE="${QUESTION_FILE:-$INSTRUCTION_ROOT/ArxivQA/test_3000.json}"
ANNOTATION_FILE="${ANNOTATION_FILE:-$INSTRUCTION_ROOT/ArxivQA/test_3000.json}"
