...
RESULT_DIR="${RESULT_DIR:-./results/UCIT/each_dataset/IconQA}"
QUESTION_FILE="${QUESTION_FILE:-$INSTRUCTION_ROOT/IconQA/test_3000.json}"
ANNOTATION_FILE="${ANNOTATION_FILE:-$INSTRUCTION_ROOT/IconQA/test_3000.json}"
